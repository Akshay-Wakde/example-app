...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{asset('assets/site//img/core-img/favicon.png')}}">
...
<body>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alimeNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="./index.html"><img src="{{asset('assets/site/img/core-img/logo.png')}}" alt=""></a>
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            @foreach($showBanners as $banners)
                
                    <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url('{{asset('uploads/banners/'.$banners['image_name'])}}');">
            ...
            <!-- Single Slide -->
            <!-- <div class="single-welcome-slide bg-img bg-overlay" style="background-image: url({{asset('assets/site/img/bg-img/2.jpg')}});">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
            ...
            <div class="row alime-portfolio">
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="100ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/3.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/3.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item video human mb-30 wow fadeInUp" data-wow-delay="300ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/4.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/4.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item country mb-30 wow fadeInUp" data-wow-delay="500ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/5.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/5.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="700ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/6.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/6.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="100ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/7.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/7.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item video country mb-30 wow fadeInUp" data-wow-delay="300ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/8.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/8.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="500ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/10.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/10.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item nature mb-30 wow fadeInUp" data-wow-delay="700ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/9.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/9.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-6 single_gallery_item video country mb-30 wow fadeInUp" data-wow-delay="100ms">
                    <div class="single-portfolio-content">
                        <!-- <img src="{{asset('assets/site/img/bg-img/36.jpg')}}" alt=""> -->
                        <iframe width="599.4" height="321.4"
                        src="{{$url['url']}}">
                        </iframe> 
                        <!-- <div class="hover-content">
                            <a href="https://www.youtube.com/embed/tgbNymZ7vqY" class="portfolio-img">+</a>
                        </div> -->
                    </div>
                </div>
                @endforeach
                ...
                <div class="col-12 col-sm-6 col-lg-3 single_gallery_item human mb-30 wow fadeInUp" data-wow-delay="300ms">
                    <div class="single-portfolio-content">
                        <img src="{{asset('assets/site/img/bg-img/37.jpg')}}" alt="">
                        <div class="hover-content">
                            <a href="{{asset('assets/site/img/bg-img/37.jpg')}}" class="portfolio-img">+</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="follow-area clearfix">
        ...
        <div class="instragram-feed-area owl-carousel">
            ...
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/11.jpg')}}" alt="">
            ...
            <!-- Single Instagram Item -->
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/12.jpg')}}" alt="">
                <div class="instagram-hover-content text-center d-flex align-items-center justify-content-center">
                    <a href="#">
                        <i class="ti-instagram" aria-hidden="true"></i>
                        <span>Alime_photographer</span>
            ...
            <!-- Single Instagram Item -->
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/13.jpg')}}" alt="">
                <div class="instagram-hover-content text-center d-flex align-items-center justify-content-center">
                    <a href="#">
                        <i class="ti-instagram" aria-hidden="true"></i>
                        <span>Alime_photographer</span>
            ...
            <!-- Single Instagram Item -->
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/14.jpg')}}" alt="">
                <div class="instagram-hover-content text-center d-flex align-items-center justify-content-center">
                    <a href="#">
                        <i class="ti-instagram" aria-hidden="true"></i>
                        <span>Alime_photographer</span>
            ...
            <!-- Single Instagram Item -->
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/15.jpg')}}" alt="">
                <div class="instagram-hover-content text-center d-flex align-items-center justify-content-center">
                    <a href="#">
                        <i class="ti-instagram" aria-hidden="true"></i>
                        <span>Alime_photographer</span>
            ...
            <!-- Single Instagram Item -->
            <div class="single-instagram-item">
                <img src="{{asset('assets/site/img/bg-img/16.jpg')}}" alt="">
                <div class="instagram-hover-content text-center d-flex align-items-center justify-content-center">
                    <a href="#">
                        <i class="ti-instagram" aria-hidden="true"></i>
                        <span>Alime_photographer</span>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
                        ...
                        <div class="footer-logo">
                            <a href="#"><img src="{{asset('assets/site/img/core-img/logo2.png')}}" alt=""></a>
                        </div>
                        <!-- Social Info -->
    ...
    <!-- All Plugins -->
    <script src="{{asset('assets/site/js/alime.bundle.js')}}"></script>
    <!-- Active -->
    <script src="{{asset('assets/site/js/default-assets/active.js')}}"></script>
