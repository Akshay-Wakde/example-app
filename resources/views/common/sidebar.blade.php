				...
				<nav class="sidebar-wrapper">
					...
					<div class="brand">
						<a href="{{route('home')}}" class="logo">
							<img src="{{asset('assets/images/logo.svg')}}" class="d-none d-md-block me-4" alt="Rapid Admin Dashboard" />
							<img src="{{asset('assets/images/logo-sm.svg')}}" class="d-block d-md-none me-4" alt="Rapid Admin Dashboard" />
						</a>
					</div>
					<!-- Sidebar brand ends -->
				...
				<div class="sidebar-menu">
						<div class="sidebarMenuScroll">
							<ul>
								<li class="{{ request()->is('home') ? 'active-page-link' : '' }}">
									<a href="{{route('home')}}">
								...
								<li class="{{ request()->is('banner.list') ? 'sidebar-dropdown active' : 'sidebar-dropdown' }}">
									...
									<div class="sidebar-submenu">
										<ul>
											...
											<li class="{{ request()->is('banner.list') ? 'active-page-link' : '' }}">
												<a href="{{route('banner.list')}}">Banners</a>
											</li>
                                            <li class="{{ request()->is('url.list') ? 'active-page-link' : '' }}">
												<a href="{{route('url.list')}}">Video URLs</a>
											</li>
										</ul>
									</div>
								</li>
